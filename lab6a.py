...
class Student:
    ...
    def displayGPA(self):
        try:
            ...
            return 'GPA of student ' + self.name + ' is ' + str(0.0)
        except:
            return 'GPA of student ' + self.name + ' cannot be claculated.'
    ...
    def displayCourses(self):
        ...
        for course_name in self.courses:
            if self.courses[course_name] > 0.0:
                passed.append(course_name)
        return passed
